local Library = loadstring(game:HttpGetAsync("https://github.com/ActualMasterOogway/Fluent-Renewed/releases/download/v1.0.4/Fluent.luau"))()
local SaveManager = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Vallmerka/Fluent-Renewed/master/Addons/SaveManager.luau"))()
local InterfaceManager = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Vallmerka/Fluent-Renewed/master/Addons/InterfaceManager.luau"))()
-- Module
...
local Config = {
    ...
    --[[Advanced Speed]]
    AIR_MAX_SPEED = 66.5,        -- The speed at which AIR_MAX_SPEED_FRIC is applied.
